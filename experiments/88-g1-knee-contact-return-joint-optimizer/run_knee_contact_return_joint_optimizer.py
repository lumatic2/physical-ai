"""Optimize knee, contact, slip, and return around the no-fall visible G1 branch."""
...
def optimizer_score(run: dict[str, Any]) -> float:
    ...
    score += 220.0 * gap["drop_shortfall_m"] / 0.08
    score += 360.0 * gap["knee_shortfall_rad"] / 0.60
    score += 160.0 * gap["hip_shortfall_rad"] / 0.35
    score += 420.0 * gap["slip_excess_m"] / 0.08
    score += 420.0 * max(0.0, 0.90 - run["foot_contact_ratio"])
    score += 360.0 * max(0.0, 0.74 - run["final_height"])
    score += 140.0 * max(0.0, -run["min_support_margin"])
    score += 140.0 * max(0.0, -run["min_zmp_margin"])
...
def variants() -> list[dict[str, Any]]:
    ...
    teacher = {**common, "drop": 0.080, "joint_kp": 26.0, "torque_clip": 36.0, "foot_kp_xy": 500.0, "foot_force_clip": 380.0, "descend_s": 3.8, "recapture_s": 1.6, "return_s": 2.6, "horizon_steps": 7, "w_support": 9800.0, "w_slip": 8400.0, "w_stand": 880.0, "return_joint_kp": 46.0, "return_torque_clip": 66.0, "knee_amp": 0.08, "hip_bias": 0.14, "w_knee": 58.0, "w_hip": 320.0, "pose_health_floor": 0.16, "w_depth_cap": 22000.0, "recapture_drop": 0.10}
    return [
        {**teacher, "attempt": "baseline-exp87-return-heavy", "max_blend": 0.505, "residual_scale": 0.060, "w_height": 120.0, "depth_cap": 0.18, "w_stand": 1100.0, "return_joint_kp": 50.0, "return_torque_clip": 70.0, "return_s": 2.7},
        {**teacher, "attempt": "knee09-contact560", "max_blend": 0.505, "residual_scale": 0.060, "w_height": 118.0, "depth_cap": 0.17, "knee_amp": 0.090, "hip_bias": 0.145, "w_knee": 92.0, "w_hip": 330.0, "foot_kp_xy": 560.0, "foot_force_clip": 440.0, "w_slip": 12000.0, "w_support": 13000.0, "w_contact": 760.0, "w_stand": 1180.0, "return_joint_kp": 52.0, "return_torque_clip": 72.0, "return_s": 2.8},
        {**teacher, "attempt": "knee10-contact580", "max_blend": 0.505, "residual_scale": 0.060, "w_height": 118.0, "depth_cap": 0.17, "knee_amp": 0.100, "hip_bias": 0.145, "w_knee": 118.0, "w_hip": 320.0, "foot_kp_xy": 580.0, "foot_force_clip": 460.0, "w_slip": 13500.0, "w_support": 14500.0, "w_contact": 820.0, "w_stand": 1200.0, "return_joint_kp": 52.0, "return_torque_clip": 72.0, "return_s": 2.8},
        {**teacher, "attempt": "knee11-contact600", "max_blend": 0.505, "residual_scale": 0.060, "w_height": 118.0, "depth_cap": 0.16, "knee_amp": 0.110, "hip_bias": 0.140, "w_knee": 140.0, "w_hip": 300.0, "foot_kp_xy": 600.0, "foot_force_clip": 480.0, "w_slip": 15000.0, "w_support": 16000.0, "w_contact": 900.0, "w_stand": 1240.0, "return_joint_kp": 54.0, "return_torque_clip": 74.0, "return_s": 2.9},
        {**teacher, "attempt": "knee10-tight-slip", "max_blend": 0.502, "residual_scale": 0.058, "w_height": 116.0, "depth_cap": 0.15, "knee_amp": 0.100, "hip_bias": 0.140, "w_knee": 130.0, "w_hip": 300.0, "foot_kp_xy": 620.0, "foot_force_clip": 500.0, "w_slip": 18000.0, "w_support": 17000.0, "w_contact": 980.0, "w_stand": 1260.0, "return_joint_kp": 54.0, "return_torque_clip": 74.0, "return_s": 2.9, "return_slip_floor": 0.050},
        {**teacher, "attempt": "knee10-long-recap", "max_blend": 0.502, "residual_scale": 0.058, "w_height": 116.0, "depth_cap": 0.16, "knee_amp": 0.100, "hip_bias": 0.140, "w_knee": 130.0, "w_hip": 300.0, "foot_kp_xy": 600.0, "foot_force_clip": 480.0, "w_slip": 15000.0, "w_support": 16000.0, "w_contact": 900.0, "w_stand": 1260.0, "return_joint_kp": 54.0, "return_torque_clip": 74.0, "recapture_s": 1.9, "return_s": 3.0, "horizon_steps": 8},
        {**teacher, "attempt": "knee09-early-return", "max_blend": 0.500, "residual_scale": 0.058, "w_height": 114.0, "depth_cap": 0.15, "knee_amp": 0.090, "hip_bias": 0.135, "w_knee": 120.0, "w_hip": 280.0, "foot_kp_xy": 600.0, "foot_force_clip": 480.0, "w_slip": 16000.0, "w_support": 16500.0, "w_contact": 940.0, "w_stand": 1300.0, "return_joint_kp": 56.0, "return_torque_clip": 76.0, "descend_s": 3.55, "return_s": 2.75},
        {**teacher, "attempt": "knee08-contact-heavy", "max_blend": 0.500, "residual_scale": 0.057, "w_height": 112.0, "depth_cap": 0.15, "knee_amp": 0.085, "hip_bias": 0.135, "w_knee": 110.0, "w_hip": 280.0, "foot_kp_xy": 640.0, "foot_force_clip": 520.0, "w_slip": 20000.0, "w_support": 18500.0, "w_contact": 1100.0, "w_stand": 1320.0, "return_joint_kp": 56.0, "return_torque_clip": 76.0, "return_slip_floor": 0.045},
        {**teacher, "attempt": "knee11-depth-cap14", "max_blend": 0.505, "residual_scale": 0.059, "w_height": 116.0, "depth_cap": 0.14, "knee_amp": 0.110, "hip_bias": 0.135, "w_knee": 150.0, "w_hip": 280.0, "foot_kp_xy": 620.0, "foot_force_clip": 500.0, "w_slip": 18000.0, "w_support": 17000.0, "w_contact": 1000.0, "w_stand": 1280.0, "return_joint_kp": 56.0, "return_torque_clip": 76.0},
        {**teacher, "attempt": "knee12-soft-height", "max_blend": 0.508, "residual_scale": 0.060, "w_height": 112.0, "depth_cap": 0.15, "knee_amp": 0.120, "hip_bias": 0.130, "w_knee": 170.0, "w_hip": 260.0, "foot_kp_xy": 640.0, "foot_force_clip": 520.0, "w_slip": 19000.0, "w_support": 18000.0, "w_contact": 1050.0, "w_stand": 1300.0, "return_joint_kp": 58.0, "return_torque_clip": 78.0},
    ]
...
def write_summary(result: dict[str, Any], out_dir: Path) -> None:
    ...
    (out_dir / "knee-contact-return-joint-optimizer-summary.md").write_text("\n".join(lines) + "\n", encoding="utf-8")
...
def main() -> None:
    ...
    out_dir = VERIFY / "knee-contact-return-joint-optimizer"
    ...
    result = {
        ...
        "planning_gate": {
            ...
            "spec_delta": "M19 now focuses the exp87 no-fall visible branch on knee flexion, contact, slip, and terminal return as one joint objective.",
            "perspectives": {
                "product": "tests whether the remaining M19 gaps can be reduced before paying for another PPO finetune",
                "architecture": "keeps exp86/87's three-phase WBC-lite controller and changes only the candidate schedule family plus score weights",
                "security": "no credentials or external side effects",
                "qa": "native sweep records raw JSON, visible gate metrics, and joint optimizer score per schedule",
                "skeptic": "knee flexion pressure may trade directly against stance anchoring or terminal stand height",
            },
            "dod": [
                "raw native JSON per joint schedule variant",
                "summary ranks schedules and states whether any variant passes visible_8cm_gate",
            ],
        },
        "sources": [
            {
                ...
                "accessed": "2026-06-18",
                "note": "G1 lower-body degrees of freedom, joint range, and knee torque make squat geometry plausible.",
            },
            {
                "url": "https://agile.human2humanoid.com/",
                "accessed": "2026-06-18",
                "note": "ASAP reports agile Unitree G1 whole-body skills including squat and squat plus lean, but uses learned motion tracking and sim-to-real alignment.",
            },
            {
                "url": "https://hugwbc.github.io/",
                "accessed": "2026-06-18",
                "note": "Whole-body control work motivates unified locomotion/control rather than raw pose tracking for fine-grained humanoid motion.",
            },
            {
                "url": "https://arxiv.org/html/2502.12152v2",
                "accessed": "2026-06-18",
                "note": "G1 getting-up work motivates refining discovered motions into deployable transitions under additional constraints.",
            },
        ],
        "runs": [],
    }
