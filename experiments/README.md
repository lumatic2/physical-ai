...
| 03 | [digital-twin](03-digital-twin/README.md) | 하드웨어 없이 SO-100을 sim에 세우고 정책 롤아웃을 웹에서 인터랙티브로 보여줄 수 있다 | ✅ 트윈 [라이브](https://physical-ai-arm.askewly.com) + scripted pick-and-place **3단 스택** replay(IK 0.1mm). **+ Go1 live 학습정책**(`?exp=go1-walk`, onnxruntime-web closed-loop, exp04 정책). ADR [0004](../docs/adr/0004-digital-twin-stack.md)·[0005](../docs/adr/0005-learned-policy-sandbox.md) |
