...
| 07 | [command-terrain-robustness](07-command-terrain-robustness/README.md) | Go1·Spot 정책이 forward 외 strafe/turn/diagonal 및 rough terrain에서도 버티는지 측정 | ⬜ S1 command sweep PASS(Go1·Spot flat command 6종), rough terrain 남음 |
