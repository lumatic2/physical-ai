...
| 04 | [go1-rl-walk](04-go1-rl-walk/README.md) | RTX5090서 Playground Go1 joystick 정책을 직접 학습→ONNX→native mujoco에서 N초 안 넘어지고 보행 | 🔄 S0~S1 ✅ (sm_120 PASS, JAX 경로 확정) · S2 학습 다음. ADR [0005](../docs/adr/0005-learned-policy-sandbox.md) 단계 1 |
