"""Probe contact-constrained knee/hip qfrc pose assist around the G1 squat teacher."""
...
def variants() -> list[dict[str, Any]]:
    ...
    return [
        ...
        {**teacher, "attempt": "poseqfrc-light", "max_blend": 0.505, "residual_scale": 0.060, "w_height": 118.0, "depth_cap": 0.18, "w_contact": 820.0, "w_slip": 12400.0, "w_knee": 130.0, "preload_force": 35.0, "preload_height_kp": 600.0, "preload_force_clip": 110.0, "pose_qfrc_scale": 0.45, "pose_qfrc_kp": 26.0, "pose_qfrc_clip": 16.0},
        {**teacher, "attempt": "poseqfrc-medium", "max_blend": 0.505, "residual_scale": 0.060, "w_height": 118.0, "depth_cap": 0.18, "w_contact": 860.0, "w_slip": 13200.0, "w_knee": 170.0, "preload_force": 35.0, "preload_height_kp": 600.0, "preload_force_clip": 110.0, "pose_qfrc_scale": 0.70, "pose_qfrc_kp": 30.0, "pose_qfrc_clip": 22.0},
        {**teacher, "attempt": "poseqfrc-strong-health", "max_blend": 0.505, "residual_scale": 0.058, "w_height": 116.0, "depth_cap": 0.17, "w_contact": 920.0, "w_slip": 15000.0, "w_knee": 220.0, "pose_health_floor": 0.12, "preload_force": 42.0, "preload_height_kp": 650.0, "preload_force_clip": 125.0, "pose_qfrc_scale": 0.95, "pose_qfrc_kp": 34.0, "pose_qfrc_clip": 28.0, "pose_qfrc_health_floor": 0.30},
        {**teacher, "attempt": "poseqfrc-slip-tight", "max_blend": 0.500, "residual_scale": 0.056, "w_height": 114.0, "depth_cap": 0.16, "w_contact": 960.0, "w_slip": 18000.0, "w_knee": 210.0, "foot_kp_xy": 580.0, "foot_force_clip": 450.0, "preload_force": 35.0, "preload_height_kp": 620.0, "preload_force_clip": 110.0, "pose_qfrc_scale": 0.75, "pose_qfrc_kp": 30.0, "pose_qfrc_clip": 20.0, "pose_qfrc_health_floor": 0.35},
        {**teacher, "attempt": "poseqfrc-recapture-soft", "max_blend": 0.505, "residual_scale": 0.058, "w_height": 116.0, "depth_cap": 0.18, "recapture_s": 1.9, "return_s": 3.0, "w_contact": 880.0, "w_slip": 14200.0, "w_knee": 180.0, "preload_force": 35.0, "preload_height_kp": 600.0, "preload_force_clip": 110.0, "pose_qfrc_scale": 0.70, "pose_qfrc_kp": 28.0, "pose_qfrc_clip": 18.0, "pose_qfrc_recapture_scale": 0.30},
        {**teacher, "attempt": "poseqfrc-braked-8cm", "max_blend": 0.490, "residual_scale": 0.052, "w_height": 112.0, "depth_cap": 0.105, "w_depth_cap": 70000.0, "w_contact": 1000.0, "w_slip": 19000.0, "w_knee": 260.0, "preload_force": 35.0, "preload_height_kp": 620.0, "preload_force_clip": 110.0, "pose_qfrc_scale": 0.82, "pose_qfrc_kp": 34.0, "pose_qfrc_clip": 18.0, "pose_qfrc_health_floor": 0.42},
        {**teacher, "attempt": "poseqfrc-braked-knee", "max_blend": 0.485, "residual_scale": 0.050, "w_height": 110.0, "depth_cap": 0.095, "w_depth_cap": 90000.0, "w_contact": 1100.0, "w_slip": 22000.0, "w_knee": 320.0, "foot_kp_xy": 600.0, "foot_force_clip": 470.0, "preload_force": 32.0, "preload_height_kp": 650.0, "preload_force_clip": 105.0, "pose_qfrc_scale": 0.90, "pose_qfrc_kp": 36.0, "pose_qfrc_clip": 20.0, "pose_qfrc_health_floor": 0.48},
        {**teacher, "attempt": "poseqfrc-braked-return", "max_blend": 0.490, "residual_scale": 0.052, "w_height": 112.0, "depth_cap": 0.105, "w_depth_cap": 80000.0, "recapture_s": 2.0, "return_s": 3.1, "w_contact": 1060.0, "w_slip": 21000.0, "w_knee": 280.0, "preload_force": 35.0, "preload_height_kp": 620.0, "preload_force_clip": 110.0, "pose_qfrc_scale": 0.82, "pose_qfrc_kp": 34.0, "pose_qfrc_clip": 18.0, "pose_qfrc_health_floor": 0.45, "pose_qfrc_recapture_scale": 0.20},
    ]
...
def write_summary(result: dict[str, Any], out_dir: Path) -> None:
    ...
    (out_dir / "contact-constrained-pose-qfrc-wrapper-summary.md").write_text("\n".join(lines) + "\n", encoding="utf-8")
...
def main() -> None:
    ...
    out_dir = VERIFY / "contact-constrained-pose-qfrc-wrapper"
    ...
    result = {
        ...
        "planning_gate": {
            "team_validation_mode": "manual-pass",
                "spec_delta": "M19 tests a contact-constrained qfrc action wrapper that optimizes stance preload and knee/hip pose assist together.",
            "perspectives": {
                "product": "tests whether the same G1 can keep foot contact while adding the missing visible knee flexion",
                "architecture": "keeps exp87's 3-phase teacher and adds contact-gated knee/hip qfrc pose assist plus stance preload before stepping MuJoCo",
                "security": "no credentials or external side effects",
                "qa": "native sweep records raw JSON, visible gate metrics, pose-qfrc candidates, and optimizer score per variant",
                "skeptic": "direct knee torque can improve pose metrics while destabilizing support, slip, or return",
            },
            "dod": [
                "raw native JSON per pose-qfrc variant",
