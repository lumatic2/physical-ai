"""Probe online CoM/ZMP feedback for the G1 visible squat controller."""
...
def write_summary(result: dict[str, Any], out_dir: Path) -> None:
    ...
    for run in result["runs"]:
        ...
        lines.append(
            f"| {run['attempt']} | {run['verdict']} | {run['feedback_source']} | "
...
def main() -> None:
    ...
    out_dir = VERIFY / "com-zmp-feedback"
    out_dir.mkdir(parents=True, exist_ok=True)
    base_gains = {
        "pitch": 2.0,
        "ankle_pitch": -1.4,
    ...
    variants = [
        {"attempt": "baseline-no-feedback", "source": "com", "signs": {"pitch": 0.0, "ankle_pitch": 0.0, "roll": 0.0, "ankle_roll": 0.0}, "max_blend": 0.38, "adapt_gain": 0.11},
        {"attempt": "com-feedback-a", "source": "com", "signs": {"pitch": 1.0, "ankle_pitch": 1.0, "roll": 1.0, "ankle_roll": 1.0}, "max_blend": 0.38, "adapt_gain": 0.11},
        {"attempt": "com-feedback-a-blend0p50", "source": "com", "signs": {"pitch": 1.0, "ankle_pitch": 1.0, "roll": 1.0, "ankle_roll": 1.0}, "max_blend": 0.50, "adapt_gain": 0.14, "descend_s": 3.0},
        {"attempt": "com-feedback-a-blend0p60-slow", "source": "com", "signs": {"pitch": 1.0, "ankle_pitch": 1.0, "roll": 1.0, "ankle_roll": 1.0}, "max_blend": 0.60, "adapt_gain": 0.13, "descend_s": 3.6, "return_s": 1.8},
        {"attempt": "com-feedback-a-blend0p70-slow", "source": "com", "signs": {"pitch": 1.0, "ankle_pitch": 1.0, "roll": 1.0, "ankle_roll": 1.0}, "max_blend": 0.70, "adapt_gain": 0.13, "descend_s": 3.8, "return_s": 1.8},
        {"attempt": "com-feedback-a-blend0p85-slow", "source": "com", "signs": {"pitch": 1.0, "ankle_pitch": 1.0, "roll": 1.0, "ankle_roll": 1.0}, "max_blend": 0.85, "adapt_gain": 0.12, "descend_s": 4.0, "return_s": 1.8},
        {"attempt": "com-feedback-b", "source": "com", "signs": {"pitch": -1.0, "ankle_pitch": -1.0, "roll": 1.0, "ankle_roll": 1.0}, "max_blend": 0.38, "adapt_gain": 0.11},
        {"attempt": "zmp-feedback-a", "source": "zmp", "signs": {"pitch": 1.0, "ankle_pitch": 1.0, "roll": 1.0, "ankle_roll": 1.0}, "max_blend": 0.34, "adapt_gain": 0.09},
        {"attempt": "zmp-feedback-b", "source": "zmp", "signs": {"pitch": -1.0, "ankle_pitch": -1.0, "roll": 1.0, "ankle_roll": 1.0}, "max_blend": 0.34, "adapt_gain": 0.09},
    ]
    result = {
        "planning_gate": {
            "team_validation_mode": "manual-pass",
            "spec_delta": "M19 probes explicit online CoM/ZMP recentering before another PPO or gain pass.",
            "perspectives": {
                "product": "tests the next visible squat blocker identified in ROADMAP",
                "architecture": "wraps exp52 contact-aware controller and adds only target-level feedback",
                "security": "no credentials or external side effects",
                "qa": "native sweep logs CoM/ZMP margins, stance, pose, contact, return, fall",
                "skeptic": "a heuristic feedback sign may improve a proxy while worsening true contact dynamics",
            },
            "dod": [
                "native JSON per CoM/ZMP feedback variant",
                "summary identifies whether online support recentering improves M19 gate",
            ],
        },
        "runs": [],
    }
