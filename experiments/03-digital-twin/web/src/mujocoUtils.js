...
export async function downloadExampleScenesFolder(mujoco) {
  // The set of files to stage into the WASM FS is generated by gen_scene_manifest.py
  // (walks assets/scenes/) so adding an embodiment is just "drop files + rerun the gen".
  let allFiles = await (await fetch("./assets/scenes/manifest.json")).json();
