...
- 로컬 runtime: WSL `Ubuntu-24.04`, native checkout `/home/<user>/gr00t-wbc-native`, RTX 5090 CUDA visible.
...
- GR00T source를 `/mnt/c` checkout이 아니라 WSL-native `/home/<user>/gr00t-wbc-native`로 복사하고 `install_mujoco_sim.sh`를 실행했다.
...
- HF sample data: PASS, 6 sample PKL files present under `/home/<user>/gr00t_sample_download_probe`.
