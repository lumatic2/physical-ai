...
- reward scale만 반복하지 않는다. exp30/34-38이 weak=shallow, visible=fall을 보였고, reward-only plus hand-written guards는 depth/contact/return gate에서 막혔다.
