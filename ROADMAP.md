...
- [x] exp36-101에서 controller/selector/WBC/stance curriculum/corridor PPO/reference/native/ONNX adapter/public XML/mjlab contract를 probe했다. exp101은 mjlab action-scale/order도 local rollout을 안정화하지 못해 exact XML 확보 또는 local retrain이 필요함을 확인했다.
