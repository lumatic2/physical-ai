...
- [x] exp36-93에서 controller/selector/WBC/stance curriculum/corridor PPO/return finetune/multi-step WBC projection을 probe했다. exp93 predictive sampling도 best non-fall이 drop/hip/contact/slip PASS지만 knee 0.421rad에 머물고, knee 개선 branch는 fall로 붕괴했다.
