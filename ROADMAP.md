...
- reward scale만 반복하지 않는다. exp30이 이미 weak blend=shallow, strong blend=fall을 보였고, exp34/exp35 hand-written controllers도 foot slip/contact/return gate에서 막혔다.
