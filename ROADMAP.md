...
- [x] exp36-59에서 IK/support guard/WBC/contact force/QP-lite/residual/command PPO/stance curriculum/action projection/contact-aware controller/curriculum/actuator authority/CoM-ZMP feedback/selector/teacher residual/safe-basis filter를 probe했다. safe-basis residual은 no-fall stable drop을 4.73cm->5.73cm로 늘렸지만 8cm gate는 미달이다.
- [ ] **재개** — 다음 기술 작업은 safe-basis residual fine-tune 또는 torque/contact-aware WBC로 stance foot constraint를 더 강하게 닫는 것이다.
