...
- [x] exp36-95에서 controller/selector/WBC/stance curriculum/corridor PPO/return finetune/reference ingestion을 probe했다. exp95는 G1 Moves 6s reference(root drop 20.0cm/knee 2.371/hip 1.822)를 local qpos[36] contract로 흡수했다.
