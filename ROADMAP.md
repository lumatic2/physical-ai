...
- [x] exp36-96에서 controller/selector/WBC/stance curriculum/corridor PPO/reference ingestion/native tracking을 probe했다. exp96은 G1 Moves native PD tracking이 깊이는 만들지만 1.42s fall/contact/slip으로 실패함을 확인했다.
