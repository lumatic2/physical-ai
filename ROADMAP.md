...
- [x] exp36-97에서 controller/selector/WBC/stance curriculum/corridor PPO/reference ingestion/native tracking/ONNX contract를 probe했다. exp97은 G1 Moves ONNX 160/154->29 계약 PASS와 58-d motion-command adapter gap을 확인했다.
