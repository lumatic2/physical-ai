...
- reward scale만 반복하지 않는다. exp30/34-37이 weak=shallow, visible=fall을 보였고, hand-written position/IK/support guards는 foot slip/contact/return gate에서 막혔다.
