...
- [x] exp36-100에서 controller/selector/WBC/stance curriculum/corridor PPO/reference/native/ONNX adapter/public motor XML을 probe했다. exp100은 G1 squat 가능성은 공개 근거상 있음에도 exact training-scene parity 없이는 public motor XML도 0.08~0.14s fall함을 확인했다.
