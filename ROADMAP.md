...
- [x] exp36-99에서 controller/selector/WBC/stance curriculum/corridor PPO/reference/native/ONNX adapter를 probe했다. exp99는 upstream adapter choice도 local XML/actuator에서 QACC/obs 폭주로 실패함을 확인했다.
