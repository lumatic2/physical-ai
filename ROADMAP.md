...
- [x] exp36-66에서 IK/support guard/WBC/contact force/QP-lite/residual/command PPO/stance curriculum/action projection/contact-aware controller/curriculum/actuator authority/CoM-ZMP feedback/selector/teacher residual/safe-basis/contact-WBC/actuator-qfrc/CoM-feasible trajectory/6cm-7cm transition/return clamp를 probe했다. qfrc 8cm target+r0.065+t24는 recoverable 6.00cm gate를 통과했지만 7cm+는 return/support-ZMP가 깨진다.
- [ ] **재개** — 다음 기술 작업은 depth 증폭이나 scalar return clamp가 아니라 WBC/QP return selector 또는 trajectory replan으로 7cm recoverable gate를 닫는 것이다.
