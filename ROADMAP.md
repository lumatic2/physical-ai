...
- [x] exp36-109에서 controller/selector/WBC/stance curriculum/corridor PPO/reference/native/ONNX adapter/public XML/mjlab/action-wrapper/future-reference/friction planner/contact-force audit/QP-lite/static ID-QP를 probe했다. exp108은 foot contact-force QP-lite가 no-fall/contact/slip을 지키며 7.49cm까지 전진하지만 knee/hip pose gate를 못 넘고, exp109는 exp29 visible-min/9cm full visible pose가 static inverse-dynamics contact QP에서는 plausible함을 보여 target 자체보다 dynamic controller/retrain이 병목임을 분리했다.
- [ ] **재개** — 다음 기술 작업은 static feasible visible reference를 dynamic rollout에서 추종하는 full inverse-dynamics QP controller 또는 contact-aware reference-motion policy retrain route로 전환해 exp29 visible gate와 browser replay를 닫는 것이다.

완료 기준: 🟨 M19는 균형 prior와 micro-dip/controller evidence는 확보했고 8cm depth/contact/slip+knee까지 동시에 보였으며 static ID-QP상 visible target 자체는 plausible하다고 분리했지만, "보이는 스쿼트"는 아직 완료가 아니다. 완료 조건은 exp29 visible gate를 native rollout과 browser replay가 동시에 통과하는 것이다. 증거: [exp15](experiments/15-g1-skill-baseline/README.md), [exp18](experiments/18-g1-squat-reward-smoke/README.md), [exp19](experiments/19-g1-squat-recovery-longrun/README.md), [exp20](experiments/20-g1-squat-reference-tracking/README.md), [exp21](experiments/21-g1-stabilizer-init-probe/README.md), [exp22](experiments/22-g1-squat-depth-finetune/README.md), [exp23](experiments/23-g1-squat-target-sanity/README.md), [exp24](experiments/24-g1-squat-skill-design/README.md), [exp25](experiments/25-g1-squat-depth-curriculum/README.md), [exp28](experiments/28-g1-controlled-squat-stage0p74/README.md), [exp29](experiments/29-g1-visible-squat-feasibility/README.md), [exp30](experiments/30-g1-visible-squat-controller/README.md), [exp34](experiments/34-g1-guarded-descent-controller/README.md), [exp35](experiments/35-g1-stance-anchored-squat-controller/README.md), [exp36](experiments/36-g1-wbc-ik-squat-prototype/README.md)-[exp109](experiments/109-g1-static-inverse-dynamics-contact-qp/README.md).
